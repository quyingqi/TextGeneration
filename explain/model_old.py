...
class Encoder(nn.Module):
    ...
    def __init__(self, args, embedding):
        ...
        self.gru = nn.GRU(args.char_embed_size, self.hidden_size, args.encode_layers,
                          dropout=args.encode_dropout, bidirectional=True, batch_first=True)
...
class Decoder(nn.Module):
    ...
    def __init__(self, args, embedding):
        ...
        self.gru = nn.GRU(args.hidden_size + args.word_embed_size, args.hidden_size,
